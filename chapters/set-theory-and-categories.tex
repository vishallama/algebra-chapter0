...
\begin{itemize}
    ...
    $\mc{C}$.
    \item Composition is associative in $\mc{C}^{op}$ is a direct consequence
    of composition being associative in $\mc{C}$.
    \item Identity morphisms in $\mc{C}^{op}$ are identities with respect to
    composition is a direct consequence of identity morphisms in $\mc{C}$ being
    identities with respect to composition.
\end{itemize}
